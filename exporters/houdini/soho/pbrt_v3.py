#   pbrt ROP - exports scenes to pbrt file format
#
#   Objects with File SOP referencing a ply file, build a shape and include that path
#   Geometry: spheres, 
#   Lights: disk lights and area lights only
#   
#
